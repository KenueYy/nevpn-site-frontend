const faqItems = [
  ...
  },
  {
    ...
    a: 'Да, действует гарантия «Настроим или вернём деньги». Если VPN не заработает — вернём полную сумму.',
  },
  {
  ...
  return (
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <p className="mt-3 text-lg text-navy-600">
        Всё о рабочем VPN без блокировок: настройка, тарифы, надёжность, отзывы.
      </p>
